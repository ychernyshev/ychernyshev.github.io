const jobList = [
    {
        ...
        'responsibilities': `<ul class="list-group list-group-flush type-square">
                                My responsibilities:
                                <li class="list-group-item bg-transparent">
                                    Responsible for the timely delivery of parcels and packages;
                                </li>
                                <li class="list-group-item bg-transparent">
                                    Conducted searches and retrieved overdue letters, returning them to the
    ...
    {
        'name': 'DD-CARGO INTERNATIONAL COURIER SERVICE',
    ...
    {
        'name': 'ORIFLAME COSMETICS GLOBAL AG',
        ...
        'responsibilities': `<ul class="list-group list-group-flush type-square">
                                My responsibilities:
                                <li class="list-group-item bg-transparent">
                                    Maintained effective communication with clients, addressing their inquiries and
                                    concerns.
                                </li>
                                <li class="list-group-item bg-transparent">
                                    Assisted in training new operators to ensure they were well-prepared for their
                                    roles.
                                </li>
                                <li class="list-group-item bg-transparent">
                                    Played a role in the creation of necessary documentation to support the call
                                    centre operations.
                                </li>
                            </ul>`,
        'examplePreviewUrl': '', 
    ...
    },
    {
        ...
        'responsibilities': `<ul class="list-group list-group-flush type-square">
                                My tasks were:
                                <li class="list-group-item bg-transparent">
                                    Led the process of updating web resources, ensuring a modern and user-friendly
                                    interface.
                                </li>
                                <li class="list-group-item bg-transparent">
                                    Designed and programmed web pages, enhancing the overall aesthetics and
                                    functionality of the company's site.
                                </li>
                                <li class="list-group-item bg-transparent">
                                    Provided ongoing support and improvements to the website to keep it up-to-date
                                    and efficient.
                                </li>
                                <li class="list-group-item bg-transparent">
                                ...
                                <li class="list-group-item bg-transparent">
                                    Offered valuable consultations on information security to safeguard the
